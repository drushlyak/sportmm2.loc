<?php
	...
	$table_config = array(
		...
		"table_header"		=> array(
			array('width' => '80%', 'title' => 'Наименование тэга', 'html' => 'Наименование тэга')
		),
		// Фунции логики вывода данных (внимательно к экранированию!)
		"data_nodes_cfg"	=> array(
			// Функция поля "Название тэга"
			array(
				"align"	=> 'left',
				"args"	=> '$node',
		...
		"action_nodes_cgf" 	=> array(
			...
			array(
				...
				"title"		=> 'Удалить',
				"confirm"	=> 'Вы уверены, что хотите удалить данный тэг?'
			)
		),
		...
		"main_action_block" => array(
			array(
				...
				"html"		=> 'Создать новый<br>тэг'
			),
			array(
				"acl_rule"	=> DELETE,
				"href"		=> '#',
				"html"		=> 'Удалить выбранные<br>тэги',
				"confirm"	=> 'Вы уверены что хотите удалить выделенные тэги?'
			)
		)
	);
