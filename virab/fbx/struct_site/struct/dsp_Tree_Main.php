		...
		"data_nodes_cfg"	=> array(
			...
			array(
				...
				"func"	=> create_function(
					...
					'	$res_str = "";
						if ($node["enable"])
							$res_str .= "<img src=\"images/but/active_yes.gif\" border=0 alt=\"' . _("Страница активна и участвует в отображении") . '\" title=\"' . _("Страница активна и участвует в отображении") . '\">";
						else
							$res_str .= "<img src=\"images/but/active_not.gif\" border=0 alt=\"' . _("Страница неактивна и отображение ее невозможно") . '\" title=\"' . _("Страница неактивна и отображение ее невозможно") . '\">";
						...
						if ($node["printable"])
							...
							$res_str .= "<img src=\"images/but/printable_not.gif\" border=0 alt=\"' . _("Страница для печати недоступна") . '\" title=\"' . _("Страница для печати недоступна") . '\">";
...
<div class="top_div">
	<a href="<?=$_XFA['ch_type_visual']?>"><b> &darr; <?=_("Отобразить в виде списка")?></b></a>
</div>
