...
if (!strpos('/$', SpawConfig::getStaticConfigValue('DOCUMENT_ROOT')))
...
// width 
SpawConfig::setStaticConfigItem('default_width','800px');
// height 
SpawConfig::setStaticConfigItem('default_height','500px');
//  resize direction
SpawConfig::setStaticConfigItem('resizing_directions','both');
...
SpawConfig::setStaticConfigItem(
  'PG_SPAWFM_SETTINGS',
  array(
    'allowed_filetypes'   => array('images', 'documents', 'flash', 'audio', 'video', 'archives'),  // allowed filetypes groups/extensions
    'allow_modify'        => true,         // allow edit filenames/delete files in directory
    'allow_upload'        => true,         // allow uploading new files in directory
    'chmod_to'          => 0766,          // change the permissions of an uploaded file if allowed
