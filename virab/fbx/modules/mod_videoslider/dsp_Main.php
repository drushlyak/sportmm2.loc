а<?php
	$table_config = array(
		...
		"table_header"		=> array(
			...
			array('name' => 'title', 'width' => '20%', 'title' => 'Title', 'html' => 'Название', 'sorting' => true),
			array('name' => 'url', 'width' => '20%', 'title' => 'URL', 'html' => 'Код видео', 'sorting' => true),
			array('width' => '15%', 'title' => 'Фото', 'html' => 'Фото')
		),
		...
		"data_nodes_cfg"	=> array(
			...
			array(
				...
				"func"	=> create_function(
					'$node',
					'	return "<img src=\"" . $node["main_foto80"] . "\" alt=\"\" border=\"0\" />";'
				)
			)
		),
		...
		"main_action_block" => array(
			array(
				...
				"html"		=> 'Добавить <br />видео'
			),
			array(
				"acl_rule"	=> DELETE,
				"href"		=> '#',
				"html"		=> 'Удалить выбранные<br />видео',
