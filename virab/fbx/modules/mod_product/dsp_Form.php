...
<?php
	...
	$fc->begin();
		...
		$fblock->show(TFTEXTFIELD, array(
			'id' => 'description_for_product',
			'name' => 'description_for_product',
			'label' => _('Указываем description'),
			'value' => $mod_data['description_for_product']
		));
		
		$fblock->show(TFTEXTFIELD, array(
			'id' => 'keywords_for_product',
			'name' => 'keywords_for_product',
			'label' => _('Указываем keywords'),
			'value' => $mod_data['keywords_for_product']
		));
