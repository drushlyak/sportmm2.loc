...
class SpawConfig
{
   ...
   * @static      
   */   
  static function setStaticConfigItem($name, $value, $transfer_type=SPAW_CFG_TRANSFER_NONE)
  {
   ...
   * @static      
   */         
  static function setStaticConfigValue($name, $value)
  {
   ...
   * @static      
   */         
  static function getStaticConfigValue($name)
  {
    $cfg_item = SpawConfig::getStaticConfigItem($name);
