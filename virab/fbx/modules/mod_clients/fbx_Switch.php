<?php
	...
	// Заказы клиента
	$_XFA['client_orders_redirect'] = FuseUrl('mod_order.main');
	$_XFA['client_orders']			= FuseUrl($module_var . '.' . 'client_orders', array('id_client' => '%d'));
	...
	switch($Fusebox["fuseaction"]) {
		...
		case "delete":
			...
			// Заказы клиента
		case "client_orders":
	  		include("client_orders/qry_Main.php");
	 		break;
