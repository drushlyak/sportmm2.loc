<?php
	$table_config = array(
		...
		"table_header"		=> array(
			...
			array('name' => 'title', 'width' => '20%', 'title' => 'Title', 'html' => 'Title', 'sorting' => true),
			array('name' => 'url', 'width' => '20%', 'title' => 'URL', 'html' => 'URL', 'sorting' => true),
		...
		"main_action_block" => array(
			array(
				...
				"html"		=> 'Добавить <br />анонс'
			),
			array(
				"acl_rule"	=> DELETE,
				"href"		=> '#',
				"html"		=> 'Удалить выбранные<br />анонсы',
