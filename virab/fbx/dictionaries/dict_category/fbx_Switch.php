<?php
	...
	$_XFA['moveup'] = FuseUrl($module_var . '.' . 'moveup', array('id' => '%d'));
	$_XFA['movedown'] = FuseUrl($module_var . '.' . 'movedown', array('id' => '%d'));
	...
	switch($Fusebox["fuseaction"]) {
		...
		case "moveup":
			include ("act_MoveUp.php");
			break;
		case "movedown":
			include ("act_MoveDown.php");
			break;
