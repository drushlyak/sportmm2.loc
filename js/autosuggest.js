...
_b.AutoSuggest.prototype.onKeyPress = function(a) {
	...
	var e = 27;
	var f = 1;
	switch (b) {case c:this.setHighlightedValue();f = 0;break;case e:this.clearSuggestions();break
	}
	return f
};
_b.AutoSuggest.prototype.onKeyUp = function(a) {
	...
	var d = 40;
	var e = 1;
	switch (b) {case c:this.changeHighlight(b);e = 0;break;case d:this.changeHighlight(b);e = 0;break;default:this.getSuggestions(this.fld.value)
	}
	return e
};
...
_b.AutoSuggest.prototype.doAjaxRequest = function(b) {
	...
	var c = this;
	if (typeof(this.oP.script) == "function")var d = this.oP.script(encodeURIComponent(this.sInp)); else var d = this.oP.script + this.oP.varname + "=" + encodeURIComponent(this.sInp);
	if (!d)return false;
	var e = this.oP.meth;
	var b = this.sInp;
	var f = function(a) {
...
_b.AutoSuggest.prototype.setSuggestions = function(a, b) {
	...
	if (this.oP.json) {
		...
		for (var i = 0; i < e.length; i++) {
			if (e[i].hasChildNodes())this.aSug.push({'id':e[i].getAttribute('id'),'value':e[i].childNodes[0].nodeValue,'info':e[i].getAttribute('info')})
		}
	}
...
_b.AutoSuggest.prototype.changeHighlight = function(a) {
	...
	if (!b)return false;
	var n;
	if (a == 40)n = this.iHigh + 1; else if (a == 38)n = this.iHigh - 1;
...
_b.DOM.cE = function(b, c, d, e) {
	...
	var t = typeof(d);
	if (t == "string" && !e)f.appendChild(document.createTextNode(d)); else if (t == "string" && e)f.innerHTML = d; else if (t == "object")f.appendChild(d);
	return f
};
_b.DOM.gE = function(e) {
	var t = typeof(e);
	if (t == "undefined")return 0; else if (t == "string") {
		var a = document.getElementById(e);
		if (!a)return 0; else if (typeof(a.appendChild) != "undefined")return a; else return 0
	} else if (typeof(e.appendChild) != "undefined")return e; else return 0
};
_b.DOM.remE = function(a) {
	var e = this.gE(a);
	if (!e)return 0; else if (e.parentNode.removeChild(e))return true; else return 0
};
