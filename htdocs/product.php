...
<? echo ('<script> document.getElementBytag('title').innerHTML=\"".$product_data['alternative_title']."\"; alert ('ffgfg')</script>')?>
<? echo ($product_data['alternative_title'])?>
	...
	<div class="cart-product-description-title"><h1><?=$product_data['name']?></h1></div>
