<?php
	...
	if (!$FORM_ERROR) {
		...
		if ($type == 2 && $id) {
			...
			$db->insert(CFG_DBTBL_MOD_CONTACT_IN_ORDER_PHONES, array('id_phone_storage' => $idClient, 'id_contact_in_order' => $id_contact));
		}
		...
		Location(sprintf($_XFA['cio_phones_formf'], 1, $id_client, $id_contact, serialize($params)), 0);
	}
