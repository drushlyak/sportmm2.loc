...
class Sms
{
	...
	function send($phone, $message, $originator='mycompany', $rus=0, $max_parts = 1, $udh='')
	{
		// constants
		// !!! Edit these contants after you receive an account from SMS Traffic !!!
		$smstraffic_login = "obradoval";
		$smstraffic_password = "lykyrejy";
		//$max_parts = 2; // set to 2 or more if you want messages to be split into several SMS automatically
