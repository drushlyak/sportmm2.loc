...
class SpawVars
{
   ...
   * @static   
   */              
  static function getGetVar($var_name, $empty_value='')
  {
   ...
   * @static
   */      
  static function getPostVar($var_name, $empty_value='')
  {
   ...
   * @static
   */      
  static function getFilesVar($var_name, $empty_value='')
  {
   ...
   * @static
   */      
  static function getServerVar($var_name, $empty_value='')
  {
   ...
   * @static
   */      
  static function getSessionVar($var_name, $empty_value='')
  {
   ...
   * @static
   */      
  static function setSessionVar($var_name, $value='')
  {
    global $HTTP_SESSION_VARS;
    if (isset($_SESSION))
