<?php
	$table_config = array(
		...
		"pager"				=> $datapager,
		"hide_pager"		=> false,
		"url"				=> sprintf($_XFA['phones'], $id_client),
		"nodeSet"			=> $dataSet,
		"resID"				=> $resourceId,
		"acl_rule_view"		=> VIEW,
		"select_nodes"		=> true,
		"action_nodes"		=> true,
		"sorting"			=> true,
		"form_action"		=> sprintf($_XFA['phones_delete'], 0, $id_client),
		// Массив настроек заголовка таблицы
		"table_header"		=> array(
			array('name' => 'number', 'width' => '70%', 'title' => 'Номер телефона', 'html' => 'Номер телефона', 'sorting' => true),
			array('name' => 'mobile', 'width' => '10%', 'title' => 'Мобильный', 'html' => 'Мобильный', 'sorting' => true)
		),
		// Фунции логики вывода данных
		"data_nodes_cfg"	=> array(
			// Функция поля "Номер телефона"
			array(
				"align"	=> 'center',
				"args"	=> '$node',
		...
		"action_nodes_cgf" 	=> array(
			...
			array(
				"acl_rule"	=> EDIT,
				"res_innod"	=> false,
				"href"		=> sprintf($_XFA['phones_form'], 2, '!node_id!', $id_client),
				"has_id"	=> true,
			...
			array(
				"acl_rule"	=> DELETE,
				"res_innod"	=> false,
				"href"		=> sprintf($_XFA['phones_delete'], '!node_id!', $id_client),
				"has_id"	=> true,
		...
		"main_action_block" => array(
			array(
				"acl_rule"	=> CREATE,
				"href"		=> sprintf($_XFA['phones_form'], 1, 0, $id_client),
				"html"		=> 'Добавить <br />телефон'
			),
			array(
				"acl_rule"	=> DELETE,
				"href"		=> '#',
